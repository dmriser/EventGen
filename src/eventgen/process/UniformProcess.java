 ...
 * @author dmriser
 */
public class UniformProcess implements IMCProcess{
    ...
    public UniformProcess(double beamEnergy, double thetaMin, double thetaMax, double finalEnergyMin, double finalEnergyMax) {
        random = new Random();
